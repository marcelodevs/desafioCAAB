...
![criacao-de-repositorio](imagens/criar_rep.png)
![adicao-do-readme'](imagens/adicionar_readme.png)

### 2. ✅ **Clonagem local** do repositório usando `git clone`.

![clonar-repositorio](imagens/clonar_rep.png)
...
![nova-branch](imagens/nova_branch.png)

### 4. ✅ **Edição do `README.md`** para documentar o desafio.

![edicao-readme](imagens/edicao_readme.png)
